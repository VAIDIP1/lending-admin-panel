        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                 <form method="POST" action="{{ route('systemsettings.store') }}" enctype="multipart/form-data" class="js-validation-material">
                    @csrf
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook_url" placeholder="Facebook URL" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <strong>Twitter URL <span class="required_sign">*</span></strong>
                                <input type="text" name="twitter_url" placeholder="Twitter URL" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <strong>LinkedIn URL <span class="required_sign">*</span></strong>
                                <input type="text" name="linkedin_url" placeholder="LinkedIn URL" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <strong>Instagram URL <span class="required_sign">*</span></strong>
                                <input type="text" name="instagram_url" placeholder="Instagram URL" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <strong>Default Template <span class=""></span></strong>
                                <input type="text" name="default_template" placeholder="Default Template" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                {{-- @if($systemsetting->logo && File::exists(public_path('uploads/'.$systemsetting->logo)))
                                    ...
                                    <input type="hidden" name="old_logo_file" class="form-control">
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="favicon_file" class="form-control">
                                 ...
                                 {{-- @if($systemsetting->favicon && File::exists(public_path('uploads/'.$systemsetting->favicon)))
                                    ...
                                    <input type="hidden" name="old_favicon_file" class="form-control">
                                 @else
                                    <img src="/uploads/no-image.svg" height="100" width="100" alt="No Preview" title="Default-Image"/>
                                @endif --}}
                            </div>
...
$(function() {
    $('.js-validation-material').validate({
        rules:{
            ...
            'facebook_url': {required:false, url: true},
            'twitter_url': {required:false, url: true},
            'linkedin_url': {required:false, url: true},
            'instagram_url': {required:false,  url: true},
        },
        messages:{
